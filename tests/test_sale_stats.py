...
def test_excludes_winning_below_min_and_invariants(dbmod):
    ...
    rows = [
        ...
        ("B0", 7_000_000, 10_000_000, 5_000_000),  # 0.70, 700만 → 500~1,000만
        ("B1", 8_000_000, 10_000_000, 5_000_000),  # 0.80, 800만 → 500~1,000만
        ("C0", 15_000_000, 18_000_000, 10_000_000),# 0.83, 1500만 → 1,000~2,000만
        ("C1", 16_000_000, 18_000_000, 10_000_000),# 0.89, 1600만 → 1,000~2,000만
        ("D0", 25_000_000, 27_000_000, 20_000_000),# 0.93, 2500만 → 2,000만 이상
        ("D1", 24_000_000, 27_000_000, 20_000_000),# 0.89, 2400만 → 2,000만 이상
    ]
